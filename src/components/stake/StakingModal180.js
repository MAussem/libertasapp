...
const StakingModal180 = ({ sAmount, setSAmount }) => {
  ...
  const stakingContractAddress = "0x3fBB8132A6d83469Db6B46585E7a766fd5244AC9";
  ...
  const { data: stakedBalance } = useContractStaking180Read("stakedTokens", [
    address,
  ]);
...
export default StakingModal180;
