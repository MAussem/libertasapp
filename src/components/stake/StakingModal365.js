...
const StakingModal365 = ({ sAmount, setSAmount }) => {
  ...
  const stakingContractAddress = "0xE6be8D502A5104eD2f85eb27A5eDB914AB827F78";
  ...
  const { data: stakedBalance } = useContractStaking365Read("stakedTokens", [
    address,
  ]);
...
export default StakingModal365;
